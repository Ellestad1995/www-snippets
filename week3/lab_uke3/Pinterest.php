...
/**
*
*@return an array with img, url and text
*/
public static function getPinsWithUrl($searchString){
  $bot = PinterestBot::create();

  $pins = $bot->pins->search(str_replace(" ", "%20", $searchString))->take(25)->toArray();
